...
import center from '@/views/center'
    ...
    import tijianfenlei from '@/views/modules/tijianfenlei/list'
    import yonghu from '@/views/modules/yonghu/list'
    import chat from '@/views/modules/chat/list'
    import discusstijiantaocan from '@/views/modules/discusstijiantaocan/list'
...
const routes = [{
	...
	path: '/chat',
      ...
      ,{
	path: '/discusstijiantaocan',
        name: '体检套餐评论',
        component: discusstijiantaocan
      }
      ,{
	path: '/tijiantaocan',
        name: '体检套餐',
