<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="体检报告" prop="tijianbaogao">
          <file-upload
          tip="点击上传体检报告"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tijianbaogao" label="体检报告" prop="tijianbaogao">
            <el-button type="text" size="small" @click="download(ruleForm.tijianbaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报告结果" prop="baogaojieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="报告结果"
                  v-model="ruleForm.baogaojieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baogaojieguo" label="报告结果" prop="baogaojieguo">
                    <span>{{ruleForm.baogaojieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
