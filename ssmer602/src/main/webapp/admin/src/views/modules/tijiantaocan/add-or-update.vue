<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐项目" prop="taocanxiangmu">
          <el-input v-model="ruleForm.taocanxiangmu" 
              placeholder="套餐项目" clearable  :readonly="ro.taocanxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="套餐项目" prop="taocanxiangmu">
              <el-input v-model="ruleForm.taocanxiangmu" 
                placeholder="套餐项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="体检内容" prop="tijianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tijianneirong" label="体检内容" prop="tijianneirong">
                    <span v-html="ruleForm.tijianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenlei = true;
          ...
          if(o=='taocanxiangmu'){
            this.ruleForm.taocanxiangmu = obj[o];
	    this.ro.taocanxiangmu = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/tijianfenlei/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.tijianneirong = this.ruleForm.tijianneirong.replace(reg,'../../../ssmer602/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
