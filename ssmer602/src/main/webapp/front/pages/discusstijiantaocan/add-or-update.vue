	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusstijiantaocan`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discusstijiantaocan`, this.ruleForm);
				}else{
					await this.$api.add(`discusstijiantaocan`, this.ruleForm);
				}
