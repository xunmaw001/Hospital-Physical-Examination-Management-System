<template>
	<view class="content">
		<view class="logo" v-if="false">
			<image :style='{"boxShadow":"0 0 16rpx #59f43e","borderColor":"#ccc","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210122/41917ebc613e48b7a130da9d2f5c1daf.jpg","isShow":false,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210122/41917ebc613e48b7a130da9d2f5c1daf.jpg' mode="aspectFill"></image>
		</view>
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
                        <picker @change="yonghuhunfouChange" :value="yonghuhunfouIndex" :range="yonghuhunfouOptions">
                                <view :style='{"borderColor":"rgba(51, 153, 153, 1)","backgroundColor":"#fff","borderRadius":"20rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.hunfou?ruleForm.hunfou:"请选择婚否"}}</view>
                        </picker>
                </view>
		<view>
...
<script>
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='yonghu'){
				...
				this.ruleForm.xingbie=this.yonghuxingbieOptions[0]
                        ...
                        // 自定义下拉框值
			if(this.tableName=='yonghu'){
                        	this.yonghuhunfouOptions = "未婚,已婚".split(',');
				this.ruleForm.hunfou=this.yonghuhunfouOptions[0]
			}
		...
		methods: {
                        ...
                        // 下拉变化
                        yonghuhunfouChange(e) {
                                this.yonghuhunfouIndex = e.target.value
                                this.ruleForm.hunfou = this.yonghuhunfouOptions[this.yonghuhunfouIndex]
                        },
